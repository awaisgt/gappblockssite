            ...
            <TextSection>
                ...
                <div className="prose prose-lg prose-indigo max-w-4xl mx-auto mt-6 text-gray-500">
                    <p className="text-justify py-4">
                        This website privacy policy (“Privacy Policy” or “Policy”) describe <a className="text-accent" href="https://gappblocks.com">https://gappblocks.com</a> (herein after referred to as “GAPP Blocks”, “Site” or “Website”) policy on the collection, use, and disclosure of information about you in connection with your use of the domain, <a className="text-accent" href="https://gappblocks.com">https://gappblocks.com</a> and all associated product sites listed on our Site. The terms “we”, “us” or “our”, refer to <a className="text-accent" href="https://gappblocks.com">https://gappblocks.com</a>. When you use the service available at our Website, you consent to our collection, use, and disclosure of information about you as described in this Privacy Policy. The Site is owned and controlled by <a className="text-accent" href="www.gapp.co">GAPP Company</a>, 16192 Coastal Highway, Lewes, DE 19958. 
                    </p>
