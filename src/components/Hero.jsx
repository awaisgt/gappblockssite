...
import frame from '@/images/main.svg'
import storeFrontHero from '@/images/screens/home-storefront.png'
...
function AppDemo() {
  ...
  return (
    <AppScreen className="w-full">
      <img src={storeFrontHero.src} alt="Storefront" />
    </AppScreen>
  )
}
      ...
      <Container>
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            ...
            We have got all the tools to turn your e-commerce ideas
            into reality. GAPP Blocks presents you with an easy no-code 
            ...
            <div className="mt-8 flex flex-wrap gap-x-6 gap-y-4">
              ...
              <Button className="hidden"
                ...
                variant="outline"
              >
                <span className="mx-2.5">FIND MORE</span>
              </Button>
            </div>
          </div>
           <div className="relative mt-10 sm:mt-20 lg:col-span-5 lg:row-span-2 lg:mt-0 xl:col-span-6">
            <div className="-mx-4 h-[448px] px-9 sm:mx-0 lg:absolute lg:-inset-x-10 lg:-top-10 md:-bottom-2 lg:h-auto lg:px-0 lg:pt-10">
            <Image
                src={frame}
                alt=""
                className="bg-grey-50 absolute  h-full w-full"
                unoptimized
                priority={false}
              />
            </div>
