        ...
        <main className="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
          <div className="text-center">
            <h1 className="text-4xl tracking-tight font-bold text-gray-900 sm:text-5xl md:text-6xl">
              <span className="block xl:inline">{props.headingContent ? props.headingContent.Heading1 : ""}</span>{' '}
              <span className="block text-accent xl:inline">{props.headingContent ? props.headingContent.Heading2 : ""}</span>
            </h1>
