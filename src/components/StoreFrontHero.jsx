      ...
      <Container>
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            ...
            <p className="mt-6 text-lg text-gray-600">
              We provide multiple blocks so you can easily integrate your preferred payment methods like Apple Pay and Google Pay, as well as custom extensions for order management and real-time instant notifications. Your users can now track their orders from order submission to delivery using our Uber-like interface.
            </p>
