...
const navigation = {
  ...
  social: [
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/gapp.pk/',
      icon: (props) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
                fillRule="evenodd"
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/gappdotpk',
      icon: (props) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/company/72152671/',
      icon: (props) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
                fillRule="evenodd"
            ...
            <div className="mt-8 xl:mt-0">
              ...
              <form className="mt-4 sm:flex sm:max-w-md">
                ...
                <input
                    ...
                    autoComplete="email"
                    required
                    className="appearance-none min-w-0 w-full bg-white border border-gray-300 rounded-md shadow-sm py-2 px-4 text-base text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-accent focus:border-accent focus:placeholder-gray-400"
